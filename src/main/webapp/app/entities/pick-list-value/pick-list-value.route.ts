...
import { PickListValueChildPopupComponent } from './pick-list-value-child-dialog.component';
...
export const pickListValueRoute: Routes = [
    {
        ...
        data: {
            ...
            defaultSort: 'id,asc',
            pageTitle: 'pghApp.pickListValue.home.title'
        },
...
export const pickListValuePopupRoute: Routes = [
    ...
    {
        path: 'pick-list-value/:id/child',
        component: PickListValueChildPopupComponent,
        resolve: {
            pickListValue: PickListValueResolve
        },
        data: {
