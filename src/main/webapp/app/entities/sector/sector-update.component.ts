...
export class SectorUpdateComponent implements OnInit {
    ...
    save() {
        this.isSaving = true;
        this.sector.createdAt = moment(this.createdAt, DATE_TIME_FORMAT);
        this.sector.updatedAt = moment(this.updatedAt, DATE_TIME_FORMAT);
    ...
    set sector(sector: ISector) {
        this._sector = sector;
        this.status = 1;
        this.createdAt = moment(sector.createdAt).format(DATE_TIME_FORMAT);
        this.updatedAt = moment(sector.updatedAt).format(DATE_TIME_FORMAT);
    }
}
